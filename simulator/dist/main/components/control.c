...
int getRegd(int instruction){
    ...
    int regdMask = 0x0e00;
    int regd = (instruction & regdMask) >> 9;
    return regd;
}
...
int getRegn(int instruction){
    // 8-6 bits
    int regnMask = 0x01c0;
    int regn = (instruction & regnMask) >> 6;
    return regn;
}
...
int getMode(int instruction){
    ...
    // 0: reg; 1: imm
    int modeMask = 0x0020;
    int mode = (instruction & modeMask) >> 5;
    return mode;
}
